...
// Combining named and default when importing
import User, { gravatar } from "./src/user";
...
const steve = new User("Steve Urban", "sleeveowizard@outlook.com", "nabrus.io");
console.log(steve);
const image = gravatar(steve.email);
console.log(image);